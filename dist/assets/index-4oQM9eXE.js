...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Zn,depthTest:!1,depthWrite:!1})}function Hl(){return new yi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ua(),fragmentShader:`
		...
		`,blending:Zn,depthTest:!1,depthWrite:!1})}function kl(){return new yi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ua(),fragmentShader:`
